...
<div class="wrapper">
        ...
        <form class="p-3 mt-3" action="${pageContext.request.contextPath}/authenticateUser" method="POST">
            ...
            <c:if test="${param.logout != null}">
		        <div class="text-center fs-6">
		            <p class="logout-message"><i>You have been logged out successfully</i></p>
		        </div>
        	</c:if>
