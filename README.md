...
<ul>
  ...
  <li><h3>RestApp_JERSEY_adding_subResource_N58</h3> - This is a rest-app in which there are two POJO classes Brand and Product. APIs are called based on endpoints and type of request. The type of data consumed during POST and PUT request is JSON and PLAIN_TEXT is returned in response. The type of data produced during GET request is JSON and during DELETE is PLAIN_TEXT.</li>
